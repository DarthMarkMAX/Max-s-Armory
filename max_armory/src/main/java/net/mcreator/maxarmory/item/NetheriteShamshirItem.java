...
public class NetheriteShamshirItem extends SwordItem {
	public NetheriteShamshirItem() {
		super(new Tier() {
			public int getUses() {
				return 2031;
			}
		...
		}, 3, -2f, new Item.Properties().tab(MaxArmoryModTabs.TAB_MAX_ARMORY).fireResistant());
	}

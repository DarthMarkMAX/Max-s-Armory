...
import net.mcreator.maxarmory.procedures.IronGuduoHitProcedure;
import net.mcreator.maxarmory.init.MaxArmoryModTabs;

import java.util.List;

public class IronGuduoItem extends AxeItem {
	public IronGuduoItem() {
		super(new Tier() {
			public int getUses() {
				return 250;
			}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		IronGuduoHitProcedure.execute(entity);
		return retval;
	}

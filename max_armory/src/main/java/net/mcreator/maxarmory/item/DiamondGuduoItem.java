...
import net.mcreator.maxarmory.procedures.DiamondGuduoHitProcedure;
import net.mcreator.maxarmory.init.MaxArmoryModTabs;

import java.util.List;

public class DiamondGuduoItem extends AxeItem {
	public DiamondGuduoItem() {
		super(new Tier() {
			public int getUses() {
				return 1561;
			}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		DiamondGuduoHitProcedure.execute(entity);
		return retval;
	}
